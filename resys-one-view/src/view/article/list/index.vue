        ...
        <Card>
          ...
          <div class="filterTool" style="padding-bottom: 5px">
            <div class="toolBar">
              ...
              <Button type="dashed" v-if="filterData.sortKey == 'date'"
                      @click="filterData.sortKey = 'createTime'; getData()">按发文时间倒序排序
              </Button>
              <Button type="dashed" v-if="filterData.sortKey == 'createTime'"
                      @click="filterData.sortKey = 'date'; getData()">按创建时间倒序排序
              </Button>
            </div>
          </div>
